...
class RequestManager {
  public:
     ...
     */
    DoubleListElement* PeekHeadOfBusyList() {
        return pBusyRequests_->PeekHead();
    }
     ...
     */
    DoubleList* GetWaitingRequests() {
        return pWaitingRequests_;
    }
     ...
     */
    DoubleList* GetBusyRequests() {
        return pBusyRequests_;
    }
